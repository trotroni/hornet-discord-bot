...
class NotifyView(discord.ui.View):
    ...
    @discord.ui.button(
        label="🔔 Recevoir les alertes anime",
        style=discord.ButtonStyle.green,
        custom_id="anime_notify"
    )
    async def button_anime(self, interaction: discord.Interaction, _button: discord.ui.Button):
        ...
        await interaction.response.send_message(
            "✅ Tu es maintenant abonné aux alertes anime !",
            ephemeral=True
        )